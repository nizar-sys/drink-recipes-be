@extends('layouts.app')
@section('title', 'Ubah Data Resep Minuman')

@section('title-header', 'Ubah Data Resep Minuman')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('drink-recipes.index') }}">Data Resep Minuman</a></li>
    <li class="breadcrumb-item active">Ubah Data Resep Minuman</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Data Resep Minuman</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('drink-recipes.update', $recipe) }}" method="POST" role="form"
                                    ...
                                    <select class="form-control @error('category_id') is-invalid @enderror" id="category_id"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('category_id', $recipe->category_id) == $category->id) selected @endif>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" placeholder="Nama Resep Minuman"
                                        value="{{ old('name', $recipe->name) }}" name="name" required>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('purchase_link') is-invalid @enderror"
                                        ...
                                        value="{{ old('purchase_link', $recipe->purchase_link) }}" name="purchase_link"
                                        required>
                                        ...
                                        <div class="form-group">
                                            <div class="table-responsive">
                                                <table class="table table-borderless" id="dynamic_field">
                                                    ...
                                                    <tbody>
                                                        @forelse (explode(', ', $recipe->ingredient) as $key => $item)
                                                            <tr id="row{{ $key }}" class="ingredient-row">
                                                        ...
                                                        @empty
                                                            <tr id="row1" class="ingredient-row">
                                                                <td><input type="text" name="ingredient[]"
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('step') is-invalid @enderror" id="step"
                                        placeholder="Cara Pembuatan Resep Minuman" name="step" rows="8" required>{{ old('step', $recipe->step) }}</textarea>
...
@section('script')
    <script>
        $(document).ready(function() {
            var i = {{ count(explode(', ', $recipe->ingredient)) ?: 0 }};
            $("#add").click(function() {
                i++;
